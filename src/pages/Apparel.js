...
import '../assets/apparel/styles.css';
...
const Apparel = () => {
  ...
  useEffect(() => {
    setIsLoading(true);
      ...
      //axios.get('http://localhost:8001/products/apparel')
    axios.get(`${apiUrl}/products/apparel`)
      .then(response => {
  ...
  return (
    <Container>
      ...
      <h1 className="brandTitle" data-aos="fade-up">Apparel</h1>
      <Row className="pb-5">
        {isLoading ? (
